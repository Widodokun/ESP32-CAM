//token blynk
#define BLYNK_TEMPLATE_ID "TMPL6tw2QHB5x"
#define BLYNK_TEMPLATE_NAME "esp32cam"
#define BLYNK_AUTH_TOKEN "vTdyFk2SNtTOy2FSIQ7ceNSp6wT8i5ef"
...
String myDeploymentID = "AKfycbw5T_Txu6WepEH4hyA_Z6vsMj6tvEv79l6rNI5gThYGmeOZmWThmHN3DgdLSsCgSULq";
...
Serial.print("Waktu upload ke Google Drive: ");
...
BLYNK_WRITE(V8) {
  ...
  if (value == 1) {
    Serial.println("Tombol Blynk ditekan, ambil foto...");
    SendCapturedPhotos();  // panggil fungsi kirim foto ke Google Drive
  }
}
